...
(defn meme-complete [top-text bottom-text image-url]
  (GET
    (str "https://memecomplete.com/api/memes/?source=mightyfinememes&text=" top-text " / " bottom-text "&context=" image-url)
    {:handler #()
     :error-handler #()}))
